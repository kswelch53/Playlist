...
def songs(request, song_id):
    print("This is songs function in app2 views.py")
    ...
    return render(request, 'app_two/songs.html', context)


# creates a new Song object from form data
def create_song(request):
    print("This is create_song function in app2 views.py")
...
# checks for blank form field / field length
        if len(this_title) == 0 or len(this_artist) == 0:
            ...
            return redirect('app2:create_song')
...
def add_to_playlist(request, song_id):
    print("This is add_to_playlist function in app2 views.py")
    this_song = Song.objects.get(id=song_id)
